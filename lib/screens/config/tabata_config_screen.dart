...
class TabataConfigScreen extends StatefulWidget {
  ...
  @override
  State<TabataConfigScreen> createState() => _TabataConfigScreenState();
}

class _TabataConfigScreenState extends State<TabataConfigScreen> {
  int? _expandedIndex;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConfigCard(
            label: 'Trabajo',
            value: _formatTime(config.workSeconds),
          ...
          _ConfigCard(
            ...
            value: _formatTime(config.tabataRestSeconds),
            color: AppColors.tabataRest,
            icon: Icons.hotel,
